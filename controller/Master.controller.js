sap.ui.core.mvc.Controller.extend("articlemock_ns.controller.Master", {
	...
	loadDetailView: function() {
		this.getRouter().myNavToWithoutHash({
			...
			targetViewName: "articlemock_ns.view.Detail",
			targetViewType: "XML"
		});
	},
	...
	selectFirstItem: function() {
		...
		if (aItems.length) {
			...
			this.getRouter().myNavToWithoutHash({
				currentView: this.getView(),
				targetViewName: "articlemock_ns.view.NotFound",
				targetViewType: "XML"
			});
		}
	},
